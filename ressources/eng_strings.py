...
UI_STRINGS = {
    ...
    "3d_frame_size_label": "Frame size",
    "3d_frame_size_info": "Size of the outputs",
    ...
    "3d_generated_label": "Generated object",
    ...
    "tab_llamacpp_about_instruct": "- Type your request in the <b>Input</b> textbox field</br>- (optional) modify settings to use another model, change context size or modify maximum number of tokens generated.</br>- Click the <b>Generate</b> button to generate a response to your input, using the chatbot history to keep a context.</br>- Click the <b>Continue</b> button to complete the last reply.",
    ...
    "tab_llava_about_instruct": "- Upload or import an <b>Input image</b></br>- Type your request in the <b>Input</b> textbox field</br>- (optional) modify settings to use another model, change context size or modify maximum number of tokens generated.</br>- Click the <b>Generate</b> button to generate a response to your input, using the chatbot history to keep a context.</br>- Click the <b>Continue</b> button to complete the last reply.",
    ...
    "tab_img2txt_about_instruct": "- Upload an input image by clicking on the <b>Input image</b> field</br>- (optional) modify settings to use another model, change min. and/or max. number of tokens generated.</br>- Click the <b>Generate button</b></br>- After generation, captions of the image are displayed in the Generated captions field",
    ...
    "tab_whisper_about_instruct": "- Upload an input audio file by clicking on the <b>Source audio</b> field or select the <b>micro</b> input type and record your voice</br>- Select the source language of the audio</br>- Select the task to execute : transcribe in source language or translate to english</br>- (optional) modify settings to use another model, or generate SRT-formated subtitles</br>- Click the <b>Generate</b> button</br>- After generation, audio transcription is displayed in the <b>Output text</b> field",
    ...
    "tab_txt2img_lcm_about_instruct": "- (optional) Modify the settings to generate several images in a single run or change dimensions of the outputs</br>- (optional) Select a LoRA model and set its weight</br>- Fill the <b>prompt</b> with what you want to see in your output image</br>- Click the <b>Generate</b> button</br>- After generation, generated images are displayed in the gallery. Save them individually or create a downloadable zip of the whole gallery.</br>",
    ...
    "tab_img2img_about_instruct": "- (optional) Modify the settings to use another model, generate several images in a single run</br>- (optional) Select a LoRA model and set its weight</br>- Upload, import an image or draw a sketch as an <b>Input image</b></br>- Set the balance between the input image and the prompt (<b>denoising strength</b>) to a value between 0 and 1 : 0 will completely ignore the prompt, 1 will completely ignore the input image</br>- Fill the <b>prompt</b> with what you want to see in your output image</br>- Fill the <b>negative prompt</b> with what you DO NOT want to see in your output image</br>- Click the <b>Generate</b> button</br>- After generation, generated images are displayed in the gallery. Save them individually or create a downloadable zip of the whole gallery.",
    ...
    "tab_img2img_ip_about_instruct": "- (optional) Modify the settings to use another model or generate several images in a single run</br>- (optional) Select a LoRA model and set its weight</br>- Select the IP-Adapter type to use : standard (image to image + prompt) or composition (import composition into the output image)</br>- Upload or import an image as an <b>Input image</b> (if using standard IP-Adapter)</br>- Upload an image as an <b>IP-Adapter image</b></br>- Set the balance between the input image and the prompts (Ip-Adapter image, prompts, negative prompt) by choosing a <b>denoising strength</b> value between 0.01 and 1 : 0.01 will mostly ignore the prompts, 1 will completely ignore the input image</br>- Fill the <b>prompt</b> with what you want to see in your output image</br>- Fill the <b>negative prompt</b> with what you DO NOT want to see in your output image</br>- Click the <b>Generate</b> button</br>- After generation, generated images are displayed in the gallery. Save them individually or create a downloadable zip of the whole gallery.</br>",
    ...
    "tab_img2var_about_instruct": "- Upload or import an image as an <b>Input image</b></br>- (optional) Modify the settings to generate several images in a single run</br>- Click the <b>Generate</b> button</br>- After generation, generated images are displayed in the gallery. Save them individually or create a downloadable zip of the whole gallery.",
    ...
    "tab_paintbyex_about_instruct": "- Upload or import an image using the <b>Input image</b> field</br>- Using the sketch tool of the <b>Input image field</b>, mask the area to be modified</br>- Upload or import an example image using the <b>Example image</b> field. This image will be used as an example on how to modify the masked area of the input image</br>- (optional) Modify the settings to generate several images in a single run</br>- Click the <b>Generate</b> button</br>- After generation, generated images are displayed in the gallery. Save them individually or create a downloadable zip of the whole gallery.",
    ...
    "tab_resrgan_about_instruct": "- Upload or import an <b>Input image</b> </br>- (optional) Modify the settings to change scale factor or use another model</br>- Click the <b>Generate</b> button</br>- After generation, upscaled image is displayed in the gallery.",
    ...
    "tab_gfpgan_about_instruct": "- Upload or import an <b>Input image</b></br>- (optional) Modify the settings to use another variant of the GFPGAN model</br>- Click the <b>Generate</b> button</br>- After generation, enhanced image is displayed in the gallery",
    ...
    "tab_musicgen_about_instruct": "- Fill the <b>prompt</b> by describing the music you want to generate</br>- (optional) Modify the settings to use another model or change audio duration</br>- Click the <b>Generate</b> button</br>- After generation, generated music is available to listen in the <b>Generated music<b> field.",
    ...
    "tab_audiogen_about_instruct": "- Fill the <b>Prompt</b> by describing the sound you want to generate</br>- (optional) Modify the settings to change audio duration</br>- Click the <b>Generate</b> button</br>- After generation, generated sound is available to listen in the <b>Generated sound</b> field.",
    ...
    "tab_harmonai_about_instruct": "- (optional) Modify the settings to change audio duration or choose another model</br>- Click the <b>Generate<b> button</br>- After generation, generated audio is available to listen in the <b>Output<b> field.",
    ...
    "tab_img2vid_about_instruct": "- (optional) Modify the settings to use another model, modify the number of frames to generate, fps of the output video or change dimensions of the outputs</br>- Upload or import an input image</br>- Click the <b>Generate</b> button</br>- After generation, generated video is displayed in the <b>Generated video</b> field.",
